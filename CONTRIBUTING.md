# Contributing to @mutualzz/logger

Thanks for wanting to help with **@mutualzz/logger**.

Contributions are welcome. Redistributing unofficial builds or hosting a
competing Mutualzz service is still not allowed — see [`LICENSE`](https://github.com/Mutualzz/logger/blob/master/LICENSE).
